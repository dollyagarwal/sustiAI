...
## Sample Reports
Here are examples of reports generated by SustiAI:

![Event Emissions Report](assets/report1.png)
!Benchmarking Report

## Database ER Diagram
![R Diagram

## Demo Reports with Queries sent to the API
...
**Purpose:** Compare emissions per attendee across all events for BlueSky Corp, grouped by category and scope.
